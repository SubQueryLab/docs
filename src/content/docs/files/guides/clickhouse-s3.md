...
Конечно же кроме .csv можно читать ещё множество <a href="https://clickhouse.com/docs/interfaces/formats#formats-overview" target="_blank" rel="nofollow">разных форматов</a>, и конечно же Экселек среди них нет, но мы работаем над этим.
